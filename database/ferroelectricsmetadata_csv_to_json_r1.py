...
- Read CSV files from local 'ferroelectrics_metadatabase' folder (if present)
...
def find_ferroelectrics_metadatabase_folder() -> str:
    """
    Auto-detect the ferroelectrics_metadatabase folder by checking common paths.
    Uses os.path.join for all path operations.
    
    Returns:
        String path to the first valid ferroelectrics_metadatabase folder found, or default fallback
    """
    ...
    candidates = [
        os.path.join(script_dir, "ferroelectrics_metadatabase"),
        os.path.join(script_dir, "database", "ferroelectrics_metadatabase"),
        os.path.join(script_dir, "data", "ferroelectrics_metadatabase"),
        os.path.join(script_dir, "ferroelectrics_metadatabase", "csv"),
        os.path.join(os.getcwd(), "ferroelectrics_metadatabase"),
        os.path.join(os.getcwd(), "database", "ferroelectrics_metadatabase"),
        os.path.join(os.getcwd(), "data", "ferroelectrics_metadatabase"),
        "ferroelectrics_metadatabase",  # relative to cwd
        os.path.join("database", "ferroelectrics_metadatabase"),  # relative to cwd
        os.path.join("data", "ferroelectrics_metadatabase"),  # relative to cwd
    ]
    ...
    return os.path.join("database", "ferroelectrics_metadatabase")
...
def main():
    ...
    st.markdown(
        ...
        "**Features:**\n"
        "- ✅ Auto-detect CSV files in `ferroelectrics_metadatabase` folder (with path auto-detection)\n"
    ...
    with st.sidebar:
        ...
        default_folder = find_ferroelectrics_metadatabase_folder()
